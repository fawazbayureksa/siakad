            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="text-center">Data Nilai Siswa Per Mata Pelajaran</h3>
                        ...
                        <h3><a href="index.php?Halaman=tambah_data_nilai_permapel" class="btn btn-primary"><i class="fa fa-plus"></i>Tambah Data</a></h3>
                    <?php } ?>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td width="20px">
                                                <a href="index.php?Halaman=detail_data_nilai_permapel&id=<?php echo $data['nis']; ?>" class="btn btn-success"><i class="fa fa-eye"></i></a>
                                            </td>
                                        </tr>
                                    <?php
                                    } ?>
                                ...
                                <nav>
                                    <ul class="pagination">
                                        <?php for ($i = 1; $i <= $pages; $i++) { ?>
                                            <li class="page-item">
                                                <a class="page-link" href="index.php?Halaman=data_nilai_per_mata_pelajaran&page=<?= $i ?>"><?= $i ?></a>
                                            </li>
                                        <?php } ?>
                                    </ul>
                                </nav>
