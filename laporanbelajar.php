            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="text-center">Data Laporan Hasil Belajar </h3>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td width="20px">
                                                <a href="index.php?Halaman=detail_laporan&id=<?php echo $data['nis']; ?>" class="btn btn-success"><i class="fa fa-eye"></i></a>
                                            </td>
                                        </tr>
                                    <?php
                                    } ?>
                                ...
                                <nav>
                                    <ul class="pagination">
                                        <?php for ($i = 1; $i <= $pages; $i++) { ?>
                                            <li class="page-item">
                                                <a class="page-link" href="index.php?Halaman=laporan_hasil_belajar&page=<?= $i ?>"><?= $i ?></a>
                                            </li>
                                        <?php } ?>
                                    </ul>
                                </nav>
